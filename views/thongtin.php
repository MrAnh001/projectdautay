...
► Với các địa điểm tại  Gia Nghĩa: Nhân viên giao hàng của Vuabanle sẽ chuyển hàng và bạn vui lòng thanh toán trực tiếp với nhân viên giao hàng. <br>
► Với các tỉnh thành khác: Nhân viên bưu điện sẽ chuyển hàng đến tận nhà và bạn vui lòng thanh toán trực tiếp với nhân viên bưu điện.
         ...
         <a class="tooltip" href="#demo3_tip" onmouseover="tooltip.pop(this, '#demo3_tip')">Thanh toán qua ngân hàng</a>
        <div style="display:none;">
            <div id="demo3_tip">
     ...
     <strong> (Giảm 20% phí giao hàng khi chọn hình thức thanh toán này)</strong>
                <br> Khi MTSHOP nhận được thông báo từ phía ngân hàng, chúng tôi sẽ nhanh chóng chuyển hàng cho quý khách. <br>
