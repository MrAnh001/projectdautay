...
<div id="page-top">
  <div class="pagecuston">
    <div class="wrap">
      <ul class="menu-top">
        <li >
          <h4 class="scroll" > HOTLINE: 0337 62 3334 </h4>
        </li>
    ...
    <div class="plans_table">
		...
		<form action="/login" method="POST">
			...
			<fieldset>
				...
				<p><input type="text" id="email" name="login_id" value="Nhập Email đăng nhập" onBlur="if(this.value=='')this.value='Nhập Email đăng nhập'" onFocus="if(this.value=='Nhập Email đăng nhập')this.value=''"></p> <!-- JS because of IE support; better: placeholder="mail@address.com" -->

				<p><label for="password">Mật Khẩu (*)</label></p>
				<p><input type="password" name="password" id="password" value="Nhập mật khẩu đăng nhập" onBlur="if(this.value=='')this.value='Nhập mật khẩu đăng nhập'" onFocus="if(this.value=='Nhập mật khẩu đăng nhập')this.value=''"></p> <!-- JS because of IE support; better: placeholder="password" -->
  ...
  <div id="header">
    ...
    <div id="nav-top">
     ...
     <div>
                             ...
                             <div>
                             <a href="#">Hỗ trợ đổi trả 10 ngày</a></div>
     </div>
          </div>
        </div>
