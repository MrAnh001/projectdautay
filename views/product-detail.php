 ...
 .fav {
  ...
  <a class="popup-with-zoom-shop"  href="<?='/add-cart?id=' . $product->id?>" >  <button class="btn btn-primary"> <span>MUA NGAY</span></button></a></div>
    ...
    <div class="Nati">     
        ...
        <div class="Nati-Delivery">Bảo hành chính hãng trong vòng 1 năm</div>
        <div class="Nati-Delivery">Hỗ trợ đổi trả trong vòng 10 ngày</div>
        <div class="Nati-Delivery">Tặng kèm những phụ kiện hấp dẫn khi mua</div>
        </div>
    <div class="Purc-phone">
    <div class="support-section">
    <h4>Hỗ trợ mua hàng 24/7</h4>
    <p class="support-description">Nếu bạn cần hỗ trợ đặt hàng hoặc có bất kỳ thắc mắc nào, vui lòng liên hệ qua số điện thoại dưới đây. Đội ngũ chăm sóc khách hàng của chúng tôi luôn sẵn sàng phục vụ bạn!</p>
    <div class="phone-number">
        <img alt="Phone Icon" src="images/phone.png" class="phone-icon">
        <p>
            <span class="phone">0337 62 3334</span> <br>
            <small>Nguyễn Hồng Anh</small>
        </p>
    </div>
    <p class="additional-info">Hãy gọi ngay để được tư vấn và giải đáp nhanh!</p>
</div>
...
<style>
    ...
    <div class="direct" style="display:yes;">
    <h4>Quý khách có thể trực tiếp đến cửa hàng tại:</h4>
 <p> Tổ 4 , Phường Nghĩa Phú , Thành Phố Gia Nghĩa , Tỉnh Đắk Nông</p>
    </div>
